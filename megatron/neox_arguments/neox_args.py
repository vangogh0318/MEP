...
class NeoXArgsModel(NeoXArgsTemplate):
    ...
    alibi_scaling: int = 0
    """
    scale the h. 2**0, 2**1, 2**2...
    """

    scale_factor_num: float = 0
    """
    scale the h. 2**0, 2**1, 2**2...
    """

    pos_emb: Literal[
        "learned", "rotary", "sinusoidal", "rpe", "alibi", "none", "kerple_power_ap_", "kerple_power__ap", "kerple_power_ap_ap", "kerple_power_original", "kerple_log", "kerple_power_original_norm", "kerple_power_norm_a_", "kerple_power_norm_original", "kerple_power_learned_norm_a_", "kerple_power_learned_norm", "kerple_power_learned_a_norm8", "kerple_power_a_", "kerple_power_original__","kerple_power_norm_original__", "kerple_power_norm_original_scaling__", "kerple_power_norm_clip_original_scaling__", "snope_norm_original_scaling__", "snope_norm_original_scaling_", "snope_kerplelog"
    ] = "learned"
    """
